...
export default async function SalonPage() {
  ...
  // 1. Haal de 3 nieuwste salons op
  ...
  return (
    <div className="min-h-screen bg-midnight-950 text-white">
      ...
      <PageHeader 
        title="De Salon" 
        subtitle="Exclusieve thema-collecties, elke maandag samengesteld door onze curatoren."
        // Optioneel: backgroundImage="/images/headers/salon-bg.jpg"
      />

      <div className="max-w-7xl mx-auto px-6 pb-20">
        
        {/* SUBHEADER: ALLEEN HIER NODIG */}
        <div className="mb-8 flex items-center gap-3 text-museum-gold text-sm font-bold uppercase tracking-widest">
            <Calendar size={16}/> Nu te zien
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {currentSalons.map((salon) => {
                const isLocked = !user; // Altijd premium
                        ...
                        <div className="p-8 flex-1 flex flex-col">
                            ...
                            <div className="mt-auto pt-4 border-t border-white/5 flex justify-between items-center">
                                <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">
                                    {isLocked ? 'Word lid' : 'Open Collectie'}
                                </span>
