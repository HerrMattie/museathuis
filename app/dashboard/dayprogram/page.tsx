...
export default function DayprogramDashboardPage() {
  ...
  const monthLabel = useMemo(() => {
    return monthRef.toLocaleDateString("nl-NL", {
      month: "long",
      year: "numeric",
    });
  }, [monthRef]);
      ...
      <header className="flex flex-col md:flex-row md:items-baseline md:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Overzicht van tours, focusmomenten en spellen per dag. Kies een dag
            en genereer een voorstel of alternatief.
          </p>
        </div>
      </header>
          ...
          <div className="flex items-center justify-between gap-3 mb-1">
            <div>
              ...
              <p className="text-[11px] text-slate-400">
                Genereer per type een voorstel of vervang één slot door een
                alternatief.
              </p>
            </div>
          </div>
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400">
                        Vul lege slots automatisch of vraag een alternatief voor
                        een bestaande selectie.
                      </p>
                    </div>
                    <button
                      type="button"
                        ...
                        >
                          ...
                          <div className="flex flex-col items-end gap-1">
                            <button
                              type="button"
                              onClick={() =>
                                handleGenerate(type, "replace", slotIndex)
                              }
